...
/*
var mixedArray = ["fred", true, 5, 3];

function filterNumbers(i) {
  ...
  var dogsArray = [ {
    ...
    },
    {
      ...
      {
          name: "Rupert",
          breed: "Rhodesian Ridge-back Mix",
          age: 3
      }
...
function getOlder () {
    dogsArray.forEach(function({dogsArray}, age)){
        var newAge = dogsArray.age + 1;
        dogsArray.push(newAge);
    }
}

getOlder(dogsArray.age);
